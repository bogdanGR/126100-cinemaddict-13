import {humanizeDatePopup} from "../utils/film";
      ...
      <div class="film-details__info-wrap">
        ...
        <div class="film-details__info">
          ...
          <table class="film-details__table">
            ...
            <tr class="film-details__row">
              <td class="film-details__term">${writer.size > 1 ? `Writers` : `Writer`}</td>
              <td class="film-details__cell">${Array.from(writer).map((writerItem) => writerItem).join(`, `)}</td>
            </tr>
            <tr class="film-details__row">
                <td class="film-details__term">${actor.size > 1 ? `Actors` : `Actor`}</td>
              <td class="film-details__cell">${Array.from(actor).map((actorItem) => actorItem).join(`, `)}</td>
            </tr>
            <tr class="film-details__row">
              <td class="film-details__term">Release Date</td>
              <td class="film-details__cell">${relaseDateOfFilm}</td>
            </tr>
            <tr class="film-details__row">
            ...
            <tr class="film-details__row">
              ...
              <td class="film-details__cell">
                 ${Array.from(genre).map((currentGenre) => `
          ...
          <p class="film-details__film-description">${descriptions}</p>
        </div>
      </div>

      <section class="film-details__controls">
        <input type="checkbox" class="film-details__control-input visually-hidden" id="watchlist" name="watchlist" ${inWatchlistClass}>
